...
class JavaIOSystem : public Assimp::IOSystem {
    ...
    bool Exists( const char* pFile) const
    {
	    ...
	    return call(mJniEnv, mJavaIOSystem, "com/github/dabasan/jassimp/AiIOSystem", "exists", "(Ljava/lang/String;)Z", params);

    };
    char getOsSeparator() const
    {
	    return (char) callc(mJniEnv, mJavaIOSystem, "com/github/dabasan/jassimp/AiIOSystem", "getOsSeparator", "()C");
    };
    ...
    Assimp::IOStream* Open(const char* pFile,const char* pMode = "rb")
    {
	    ...
	    jobject jStream = callo(mJniEnv, mJavaIOSystem, "com/github/dabasan/jassimp/AiIOSystem", "open", "(Ljava/lang/String;Ljava/lang/String;)Lcom/github/dabasan/jassimp/AiIOStream;", params);
	    if(NULL == jStream)
	    {
	    ...
	    size_t size = calli(mJniEnv, jStream, "com/github/dabasan/jassimp/AiIOStream", "getFileSize", "()I");
	    ...
	    if(call(mJniEnv, jStream, "com/github/dabasan/jassimp/AiIOStream", "read", "(Ljava/nio/ByteBuffer;)Z", readParams))
	    {
    ...
    void Close( Assimp::IOStream* pFile)
    {
		...
		callv(mJniEnv, mJavaIOSystem, "com/github/dabasan/jassimp/AiIOSystem", "close", "(Lcom/github/dabasan/jassimp/AiIOStream;)V", params);
    	delete pFile;
    };
...
class JavaProgressHandler : public Assimp::ProgressHandler {
    ...
    bool Update(float percentage)
    {
	    ...
	    return call(mJniEnv, mJavaProgressHandler, "com/github/dabasan/jassimp/AiProgressHandler", "update", "(F)Z", params);
    }
};
...
static bool loadMeshes(JNIEnv *env, const aiScene* cScene, jobject& jScene)
{
	for (unsigned int meshNr = 0; meshNr < cScene->mNumMeshes; meshNr++)
	{
		...
		if (!createInstance(env, "com/github/dabasan/jassimp/AiMesh", jMesh)) 
		{
			return false;
		}
		...
		if (!callv(env, jMesh, "com/github/dabasan/jassimp/AiMesh", "setPrimitiveTypes", "(I)V", setTypesParams))
		{
			return false;
		}
		...
		if (!callv(env, jMesh, "com/github/dabasan/jassimp/AiMesh", "allocateBuffers", "(IIZI)V", allocateBuffersParams))
		{
			return false;
		}
		...
		if (cMesh->HasNormals())
		{
			...
			if (!callv(env, jMesh, "com/github/dabasan/jassimp/AiMesh", "allocateDataChannel", "(II)V", allocateDataChannelParams))
			{
		...
		for (unsigned int b = 0; b < cMesh->mNumBones; b++)
		{
			...
			if (!createInstance(env, "com/github/dabasan/jassimp/AiBone", jBone)) 
			{
				return false;
			}
			...
			for (unsigned int w = 0; w < cBone->mNumWeights; w++)
			{
				...
				if (!createInstance(env, "com/github/dabasan/jassimp/AiBoneWeight", jBoneWeight))
				{
					return false;
				}
				...
				if (!callStaticObject(env, "com/github/dabasan/jassimp/Jassimp", "wrapMatrix", "([F)Ljava/lang/Object;", wrapParams, jMatrix))
				{
					return false;
				}
...
static bool loadMetadata(JNIEnv *env, const aiNode* cNode, jobject& jNode)
{
	...
	for(unsigned i = 0; i<cMetadata->mNumProperties; i++) {
		...
		if(!createInstance(env, "com/github/dabasan/jassimp/AiMetadataEntry", jAiMetadataEntry)) {
			return false;
		}
		...
		switch (cMetadataType) {
			...
			case AI_BOOL: {
                getMetadataTypeSuccess = getStaticField(env, "com/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType", "AI_BOOL", "Lcom/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType;", jAiMetadataTypeEnumValue);
            ...
            case AI_INT32: {
                getMetadataTypeSuccess = getStaticField(env, "com/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType", "AI_INT32", "Lcom/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType;", jAiMetadataTypeEnumValue);
            ...
            case AI_UINT64: {
                getMetadataTypeSuccess = getStaticField(env, "com/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType", "AI_UINT64", "Lcom/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType;", jAiMetadataTypeEnumValue);
            ...
            case AI_FLOAT: {
                getMetadataTypeSuccess = getStaticField(env, "com/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType", "AI_FLOAT", "Lcom/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType;", jAiMetadataTypeEnumValue);
            ...
            case AI_DOUBLE: {
                getMetadataTypeSuccess = getStaticField(env, "com/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType", "AI_DOUBLE", "Lcom/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType;", jAiMetadataTypeEnumValue);
            ...
            case AI_AISTRING: {
                getMetadataTypeSuccess = getStaticField(env, "com/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType", "AI_AISTRING", "Lcom/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType;", jAiMetadataTypeEnumValue);
                jMetadataData = env->NewStringUTF(static_cast<aiString*>(cData)->C_Str());
                getMetadataDataSuccess = (jMetadataData != NULL);
                break;
            }
            case AI_AIVECTOR3D: {
                getMetadataTypeSuccess = getStaticField(env, "com/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType", "AI_AIVECTOR3D",
                                                        "Lcom/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType;",
                ...
                getMetadataDataSuccess = callStaticObject(env, "com/github/dabasan/jassimp/Jassimp", "wrapVec3", "(FFF)Ljava/lang/Object;",
        ...
        if(!setObjectField(env, jAiMetadataEntry, "mType", "Lcom/github/dabasan/jassimp/AiMetadataEntry$AiMetadataType;", jAiMetadataTypeEnumValue)) {
            exceptionThrown = env->ExceptionCheck();
...
static bool loadSceneNode(JNIEnv *env, const aiNode *cNode, jobject parent, jobject* loadedNode = NULL)
{
	...
	if (!callStaticObject(env, "com/github/dabasan/jassimp/Jassimp", "wrapMatrix", "([F)Ljava/lang/Object;", wrapMatParams, jMatrix))
	{
		return false;
	}
	...
	jobject jNode;
	if (!callStaticObject(env, "com/github/dabasan/jassimp/Jassimp", "wrapSceneNode",
...
static bool loadMaterials(JNIEnv *env, const aiScene* cScene, jobject& jScene) 
{
	for (unsigned int m = 0; m < cScene->mNumMaterials; m++)
	{
		...
		if (!createInstance(env, "com/github/dabasan/jassimp/AiMaterial", jMaterial))
		{
			return false;
		}
		...
		for (int ttInd = aiTextureType_DIFFUSE; ttInd < aiTextureType_UNKNOWN; ttInd++) 
		{
			...
			if (!callv(env, jMaterial, "com/github/dabasan/jassimp/AiMaterial", "setTextureNumber", "(II)V", setNumberParams))
			{
				return false;
			}
		}
		...
		for (unsigned int p = 0; p < cMaterial->mNumProperties; p++)
		{
				...
				cProperty->mDataLength == 3 * sizeof(float)) 
			{
				...
				if (!callStaticObject(env, "com/github/dabasan/jassimp/Jassimp", "wrapColor3", "(FFF)Ljava/lang/Object;", wrapColorParams, jData))
				{
					return false;
				}

				constructorParams[4].l = jData;
				if (!createInstance(env, "com/github/dabasan/jassimp/AiMaterial$Property", "(Ljava/lang/String;IIILjava/lang/Object;)V", 
				...
				cProperty->mDataLength == 4 * sizeof(float)) 
			{
				...
				if (!callStaticObject(env, "com/github/dabasan/jassimp/Jassimp", "wrapColor4", "(FFFF)Ljava/lang/Object;", wrapColorParams, jData))
				{
					return false;
				}
			...
			else 
			{
				...
				if (!createInstance(env, "com/github/dabasan/jassimp/AiMaterial$Property", "(Ljava/lang/String;IIII)V", constructorParams, jProperty))
				{
					return false;
				}
...
static bool loadAnimations(JNIEnv *env, const aiScene* cScene, jobject& jScene) 
{
	...
	for (unsigned int a = 0; a < cScene->mNumAnimations; a++)
	{
		...
		if (!createInstance(env, "com/github/dabasan/jassimp/AiAnimation", "(Ljava/lang/String;DD)V", newAnimParams, jAnimation))
		{
			return false;
		}
		...
		for (unsigned int c = 0; c < cAnimation->mNumChannels; c++)
		{
			...
			if (!createInstance(env, "com/github/dabasan/jassimp/AiNodeAnim", "(Ljava/lang/String;IIIII)V", newNodeAnimParams, jNodeAnim))
			{
				return false;
			}
...
static bool loadLights(JNIEnv *env, const aiScene* cScene, jobject& jScene) 
{
	...
	for (unsigned int l = 0; l < cScene->mNumLights; l++)
	{
		...
		if (!callStaticObject(env, "com/github/dabasan/jassimp/Jassimp", "wrapColor3", "(FFF)Ljava/lang/Object;", wrapColorParams, jDiffuse))
		{
			return false;
		}
		...
		if (!callStaticObject(env, "com/github/dabasan/jassimp/Jassimp", "wrapColor3", "(FFF)Ljava/lang/Object;", wrapColorParams, jSpecular))
		{
			return false;
		}
		...
		if (!callStaticObject(env, "com/github/dabasan/jassimp/Jassimp", "wrapColor3", "(FFF)Ljava/lang/Object;", wrapColorParams, jAmbient))
		{
			return false;
		}
		...
		if (!callStaticObject(env, "com/github/dabasan/jassimp/Jassimp", "wrapVec3", "(FFF)Ljava/lang/Object;", wrapVec3Params, jPosition))
		{
			return false;
		}
		...
		if (!callStaticObject(env, "com/github/dabasan/jassimp/Jassimp", "wrapVec3", "(FFF)Ljava/lang/Object;", wrapVec3Params, jDirection))
		{
			return false;
		}
		...
		if (!createInstance(env, "com/github/dabasan/jassimp/AiLight", "(Ljava/lang/String;ILjava/lang/Object;Ljava/lang/Object;FFFLjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;FF)V",
			params, jLight))
		{
			return false;
		}
...
static bool loadCameras(JNIEnv *env, const aiScene* cScene, jobject& jScene) 
{
	...
	for (unsigned int c = 0; c < cScene->mNumCameras; c++)
	{
		...
		jobject jPosition;
		SmartLocalRef refPosition(env, jPosition);
		if (!callStaticObject(env, "com/github/dabasan/jassimp/Jassimp", "wrapVec3", "(FFF)Ljava/lang/Object;", wrapPositionParams, jPosition))
		{
			return false;
		}
		...
		if (!callStaticObject(env, "com/github/dabasan/jassimp/Jassimp", "wrapVec3", "(FFF)Ljava/lang/Object;", wrapPositionParams, jUp))
		{
			return false;
		}
		...
		if (!callStaticObject(env, "com/github/dabasan/jassimp/Jassimp", "wrapVec3", "(FFF)Ljava/lang/Object;", wrapPositionParams, jLookAt))
		{
			return false;
		}
		...
		if (!createInstance(env, "com/github/dabasan/jassimp/AiCamera", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;FFFF)V",
			params, jCamera))
		{
			return false;
		}
  ...
  (JNIEnv *env, jclass jClazz, jstring jFilename, jlong postProcess, jobject ioSystem, jobject progressHandler)
{
	...
	if (!createInstance(env, "com/github/dabasan/jassimp/AiScene", jScene)) 
	{
		goto error;
	}
